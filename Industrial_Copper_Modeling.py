...
def predict_status(ctry,itmtp,aplcn,wth,prdrf,qtlg,cstlg,tknslg,slgplg,itmdt,itmmn,itmyr,deldtdy,deldtmn,deldtyr):
    ...
    with open("D:\Data science\Project 5\Classification_model.pkl","rb") as f:
...
def predict_selling_price(ctry,sts,itmtp,aplcn,wth,prdrf,qtlg,cstlg,
    ...
    with open("D:\Data science\Project 5\Regression_Model.pkl","rb") as f:
...
with st.sidebar:
    option = option_menu('COPPER', options=["PREDICT SELLING PRICE", "PREDICT STATUS"])
